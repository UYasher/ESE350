...
//ripped from wikipedia for bressenham
plotLineLow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t color)
{
	int dx = x1 - x0;
	int dy = y1 - y0;
	int yi = 1;
...
plotLineHigh(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t color)
{
	int dx = x1 - x0;
	int dy = y1 - y0;
	int xi = 1;
